...
export function ThreatBoardTabs() {
  return (
    <nav className="flex gap-2 overflow-x-auto border-b border-civic-line pb-2" aria-label="ThreatBoard">
      {tabs.map((tab) => (
        <NavLink
          className={({ isActive }) =>
            cn(
              ...
              isActive
                ? "border-civic-teal/50 bg-civic-teal/10 text-civic-teal"
                : "border-civic-line bg-[#14181d] text-civic-muted hover:bg-[#20252b] hover:text-white",
            )
          }
