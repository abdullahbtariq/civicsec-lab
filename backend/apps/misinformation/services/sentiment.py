...
_POSITIVE = frozenset(
    {
        "good", "great", "excellent", "positive", "wonderful", "happy", "love", "best",
        "better", "hope", "hopeful", "support", "helping", "together", "peace", "freedom",
        "fair", "honest", "truth", "justice", "safe", "proud", "strong", "win", "victory",
        "right", "trust", "protect", "community", "unity", "care", "kind", "genuine",
        "real", "important", "meaningful", "vital", "welcome", "open", "inclusive",
        "equal", "democratic", "accountable", "transparent", "progress", "forward",
        "success", "building", "celebrate", "amazing", "respect", "dignity",
        "resilience", "solidarity", "empowered", "opportunity", "collaboration",
    }
)

_NEGATIVE = frozenset(
    {
        "bad", "wrong", "terrible", "horrible", "hate", "corrupt", "evil", "threat",
        "danger", "attack", "destroy", "enemy", "lie", "lies", "fake", "cheat",
        "stolen", "rigged", "fraud", "disgrace", "shameful", "criminal", "illegal",
        "violent", "violence", "dangerous", "fear", "scared", "angry", "outrage",
        "betrayal", "traitor", "conspiracy", "manipulate", "scam", "invasion",
        "takeover", "radical", "poison", "toxic", "mislead", "censorship",
        "silenced", "suppressed", "agenda", "hoax", "propaganda", "alarming",
        "alarmed", "exposed", "infiltrated", "controlled", "puppet", "regime",
        "collusion", "overthrow", "collapse", "catastrophe", "disaster",
        "horrific", "disgust", "reject", "refuse",
    }
)

_TOXIC = frozenset(
    {
        "trash", "garbage", "scum", "filth", "disgrace", "pathetic", "worthless",
        "stupid", "idiot", "moron", "coward", "parasite", "vermin", "rot",
        "despicable", "vile", "degenerate", "filthy", "loser",
    }
)
